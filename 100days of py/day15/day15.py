'''
Creating a coffee machine project

PROGRAMMING REQUIREMENTS
1. print report.
  a. Prompt user by asking "What would you like?" (espresso/latte/cappuccio):
  b. Check the users input to decide what to do next
  c. the prompt should show every time action has completed, e.g. once the drink is
      dispensed. The Prompt should show again to serve the next customer.
       
2.Turn off the coffee machine by entering "off" to the prompt.
  "a. for maintainers of the coffee machine, they can use :"off" as the secret word to turn off
       the machine. Your code should end execution when this happend
       
3. Print report
  a. when the user enters "report" . to the prompt, the report should be generated that shows the
     current resources values e.g
  --water: 100ml
  --milk:  50ml
  --Coffee:76g
  --Money: 2.5
  
4. Check resources sufficient? a. 
When the user chooses 
a drink, the program should check if there are enough resources to make that drink. 
